...
**Date:** 2025-11-07
**Status:** Proposed
**Purpose:** Comprehensive roadmap to make c4r more user-friendly and feature-complete
...
This feature map outlines a comprehensive plan to enhance the c4r package's user-friendliness. The package currently provides solid foundations for C4 diagram creation but has significant opportunities for improvement in:
...
The proposed features are organized into 4 priority tiers across 3 development phases (Short-term, Medium-term, Long-term).
...
- **Working demos** through `c4_demo()`
- **Theme support** with 3 built-in options
- **Test coverage** for core functionality

### Pain Points ⚠️

1. **Verbose element creation** - Each element requires separate constructor call
2. **List-heavy syntax** - Relationships and elements must be wrapped in lists
...
**Problem:** Creating multiple elements requires repetitive constructor calls
...
**Impact:** High - Significantly reduces code verbosity for large diagrams
...
**Problem:** Building diagrams requires managing many separate list objects
...
- Less list management
- Clearer intent
- Easier to modify incrementally
...
**Improvements:**
- Show function name in error
- Suggest fixes when possible
- Link to documentation
- Show current type vs. expected type
...
**Problem:** Can't visually group related components or show deployment boundaries
...
**Visual Options:**
- **Sync vs. Async**: Different arrow styles
- **Bidirectional**: Double-headed arrows
- **Conditional**: Dashed lines for optional flows
- **Order/Sequence**: Numbered relationships
...
**Implementation:**
- Use `DiagrammeRsvg::export_svg()` for SVG
- Use `rsvg::rsvg_png()` for PNG
- Use `grDevices::pdf()` for PDF
- Keep existing HTML export
...
- Click to expand/collapse detail levels
...
**Format:**
- PDF for printing
- Interactive HTML version on website
...
- ✅ **UX-3** `summary()` method for diagrams
...
**Deliverables:**
- Significantly reduced code verbosity
- Robust validation system
- Multi-format export
- Rich documentation with examples
- Stable API ready for 1.0
...
**Deliverables:**
- Mature, feature-complete package
...
These features have lower priority but could be added based on user demand:
...
- **FEAT-15** Performance optimization for large diagrams (1000+ elements)
...
- [PlantUML C4](https://github.com/plantuml-stdlib/C4-PlantUML) - PlantUML integration

### R Visualization Packages

- [DiagrammeR](https://rich-iannone.github.io/DiagrammeR/) - Graph visualization (current backend)
- [visNetwork](https://datastorm-open.github.io/visNetwork/) - Interactive network graphs
- [ggraph](https://ggraph.data-imaginist.com/) - Grammar of graphics for networks

### Architecture Documentation Tools

- [arc42](https://arc42.org/) - Architecture documentation template
- [Structurizr DSL](https://github.com/structurizr/dsl) - Text-based C4 diagrams
...
**Questions or feedback?** Open an issue at https://github.com/fabiandistler/c4r/issues
